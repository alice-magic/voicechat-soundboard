...
dependencies {
    ...
    compileOnly("de.maxhenkel.voicechat:voicechat-api:${sc.properties["deps.svc_api"]}")
    modRuntimeOnly("maven.modrinth:simple-voice-chat:${sc.properties["deps.svc_mod"]}")
}
...
publishMods {
    ...
    displayName = "SVC Soundboard ${version}"
